 ...
 * idt.c
 * 
 *	Initialization of the Interrupt Descriptor Table (IDT)
 *
 */
 
#include "idt.h"

// This will be defined in the assembly code
extern void 
idt_flush(uint32_t);
 ...
 * idt_set_gate()
 *
 * 	A private function used to set IDT entries
 *
 */
static void 
...
/*
 * idt_set_gate(index, base, sel, flags)
 *
 * 	A private function used to set IDT entries
 *
 * Inputs: 
 *		index 		: the index of the entry to be entered
 * 		base 		: the base address of the interrupt service routine (ISP)
